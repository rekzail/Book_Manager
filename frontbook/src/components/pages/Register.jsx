...
export default function Register() {
  return (
   <section className="vh-70 sp" style={{backgroundColor: '#eee'}}>
          ...
          <div className="card-body p-md-5">
            <div className="row justify-content-center">
                ...
                <form className="mx-1 mx-md-4">
                  ...
                  <div className="d-flex flex-row align-items-center mb-4">
                    ...
                    <div className="form-outline flex-fill mb-0">
                      ...
                      <label className="form-label" htmlFor="form3Example4cd">Repite Contraseña</label>
                    </div>
                  </div>
                  <div className="form-check d-flex justify-content-center mb-5">
                    <input className="form-check-input me-2" type="checkbox" defaultValue id="form2Example3c" />
                    <label className="form-check-label" htmlFor="form2Example3">
                    Estoy de acuerdo con todas las declaraciones <a href="#!">Terminos y Servicios</a>
                    </label>
                  </div>
              ...
              <div className="col-md-10 col-lg-6 col-xl-7 d-flex align-items-center order-1 order-lg-2">
                <img src="https://mdbcdn.b-cdn.net/img/Photos/new-templates/bootstrap-registration/draw1.webp" className="img-fluid" alt="Illustration of a draw" />
              </div>
            </div>
          </div>
        </div>
